...
{
	$loginid 	= "alumni_tracker@projectmailer.xyz";
	$password 	= "alumni_trackeralumni_trackeralumni_tracker";
	$smtpserver = "mail.projectmailer.xyz";
	$smtpport 	= 587;
	$mailsender = "AlumniTracker";
	$companyname= "AlumniTracker";
	$facebook = "https://www.facebook.com/AlumniTracker";
	$twitter = "https://www.twitter.com/AlumniTracker";
	$youtube = "https://www.youtube.com/AlumniTracker";
	$linkedin = "https://www.linkedin.com/AlumniTracker";
	$companyaddress  = "AlumniO, 9-57, Wadi-e-Hadees, Hyderabad-500005, India | Email us: AlumniO@gmail.com";
	$contactno = "+91-7517680881";
	$url = "www.AlumniTracker.com";
