...
{
	echo "http://mi20.space/mailer/mailer.php?toaddress=studentprojects.live@gmail.com&subject=Helo&message=Thanks";
	...
	try {
		...
		//Recipients
		$mail->setFrom('alumni@mi20.space', 'ALUMNI TRACKING SYSTEM');
...
sendmail("kalyanij839@gmail.com","Sending mail with settings","IMAP and POP are both ways to read your Gmail messages in other email clients. IMAP can be used across multiple devices. Emails are synced in real time.","AlumniO");
?>
